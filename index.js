    ...
    <div class="xuxieji-editor-container">
      <header class="xuxieji-header">
          ...
          <div class="header-mode-switch">
              <input type="radio" name="editor_mode" id="mode_v" value="" checked />
              <label for="mode_v" class="mode-btn"></label>
              <input type="radio" name="editor_mode" id="mode_o" value="" />
              <label for="mode_o" class="mode-btn"></label>
          </div>
